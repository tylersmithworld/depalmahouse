...
Sections in `index.html`: Bass, Guitar, Keys, Drums, Horns, Strings, Vocalists, Producers/Composers, Multi-Instrumentalists, Bands/Collectives.
...
## Related
- Sessions booking page (linked in DM template): `../private/x7f3/Artist_Invite.html`
